    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans selection:bg-indigo-100">
      ...
      */}
      <div className="pt-32 pb-16 px-6 max-w-7xl mx-auto">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <form onSubmit={handleSearchSubmit} className="relative group max-w-2xl mx-auto">
             <div className="flex items-center bg-white border border-slate-200 rounded-[2rem] shadow-xl overflow-hidden p-1.5 group-focus-within:border-indigo-600 transition-all">
                ...
                />
                <button type="submit" className="bg-slate-900 text-white px-10 py-5 rounded-[1.5rem] font-bold text-sm uppercase tracking-widest hover:bg-indigo-600 transition-all active:scale-95">
                   Request
                </button>
             </div>
          </form>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
             {["Mumbai", "Delhi", "Bangalore"].map((city) => (
               <button
                 ...
                 className={`px-8 py-3 rounded-2xl font-bold text-xs transition-all border ${
                   selectedCity === city 
        ...
        {/* 
          BENTO GRID INSIGHT CARDS (RE-ADDED)
        */}
